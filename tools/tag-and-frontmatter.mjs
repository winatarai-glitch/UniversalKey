...
const SCOPE_DIRS = [
  ...
  { name: 'blog-drafts',      path: '10 - Projects/<your-project>/Blog Drafts',                 type: 'blog-draft', source: null },
  { name: 'articles',         path: '10 - Projects/<your-project>/Articles',                    type: 'article', source: null },
